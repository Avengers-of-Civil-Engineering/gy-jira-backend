from jira_backend.read_env import read_env
import MySQLdb
...
def setup_mysql_db():
    ...
    cursor.execute("create database if not exists gy_jira character set utf8mb4 collate utf8mb4_general_ci;")
    cursor.execute("create database if not exists test_gy_jira character set utf8mb4 collate utf8mb4_general_ci;")
